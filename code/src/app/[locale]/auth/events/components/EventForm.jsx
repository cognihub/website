...
export default function EventForm({ serverAction, event }) {
    ...
    const { id, title, description, image, date, category, content, sciences, links, resources } = event
            ...
            <div className={styles.FormContainer}>
                <div className={styles.BasicInfoColumn}>
                    ...
                    <select
                        ...
                        required
                    >
                        {EVENT_CATEGORIES.map(category => <option value={category.value}>{category.label}</option>)}
                    </select>
